    ...
    render(){
        ...
        return(
            <React.Fragment>
                <ScrollToTop smooth />
                <Row className="mb-5">
                   <Col xs="12" sm="6" md="3" data-aos="fade-up" data-aos-duration="100">
                       <ul id="works-accordion">
                           {Col1}
                       </ul>
                   </Col>
                   <Col xs="12" sm="6" md="3" data-aos="fade-up" data-aos-duration="200">
                       <ul id="works-accordion">
                           {Col2}
                       </ul>
                   </Col>
                   <Col xs="12" sm="6" md="3" data-aos="fade-up" data-aos-duration="300">
                       <ul id="works-accordion">
                           {Col3}
                       </ul>
                   </Col>
                   <Col xs="12" sm="6" md="3" data-aos="fade-up" data-aos-duration="400">
                       <ul id="works-accordion">
                           {Col4}
                       </ul>
                   </Col>
