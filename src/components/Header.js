        ...
        <React.Fragment>
            <Row style={{minHeight:"85vh"}}>
                <Col xs ="12" xl="6" className="order-last order-xl-first">
                    ...
                    <div className="subheading-text mt-2 text-center text-xl-left">
                        <FontAwesomeIcon icon={faMapMarkerAlt} color="#FEFEFE" size="1x" />&emsp;Navi Mumbai, India
                    </div>
                    <ThreeLines className="text-center text-xl-left" />
                    <div className="header-text text-center text-xl-left">
                    ...
                    <div className="buttons text-center text-xl-left mt-4 row">
